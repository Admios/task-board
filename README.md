...
- `npm run db:seed` seeds the database with demo data, but only if therea are users already in the database. It takes five random users and generates them some random tasks.
